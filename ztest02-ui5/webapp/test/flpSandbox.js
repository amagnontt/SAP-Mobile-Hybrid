		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comnttdataztest02ui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnttdataztest02ui5-display": {
								"semanticObject": "comnttdataztest02ui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.nttdata.ztest02ui5",
									"url": sap.ui.require.toUrl("com/nttdata/ztest02ui5")
								}
							}
						}
					}
